...
namespace QuestCameraKit.WebRTC {
    // Ported from Unity's own sentis-samples BlazeDetectionSample (Pose/Assets/Scripts/BlazeUtils.cs,
    // https://github.com/Unity-Technologies/sentis-samples), renamed to avoid colliding with the
    // original "BlazeUtils" class name if that sample is ever imported into this project too.
    // Unmodified apart from the rename and this project's namespace/brace style.
    public static class BlazePoseUtils {
        // matrix utility
        ...
        private static FunctionalTensor ScoreFiltering(FunctionalTensor rawScores, float scoreThreshold) {
        ...
        private static readonly ComputeShader s_ImageTransformShader = Resources.Load<ComputeShader>("ComputeShaders/PoseImageTransform");
        private static readonly int s_ImageSample = s_ImageTransformShader.FindKernel("ImageSample");
